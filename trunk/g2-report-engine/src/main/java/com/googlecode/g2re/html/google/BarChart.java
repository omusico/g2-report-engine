 ...
 * @author Brad
 */
public class BarChart extends BoundElement {
    ...
    public void build(HTMLBuilderArgs args) {
        ...
        if(isFlipAxis()){
            ...
            args.getGoogleModules().add("barchart");
        }
        ...
        java.util.Map seriesGroupMap = new HashMap(); //Y Axis Grouping (Optional)
        java.util.Map categorySeriesMap = new HashMap(); //X Axis
        ...
        if(isFlipAxis()) {
            ...
            args.getPreScript().append("   var chart"+seq+" = new google.visualization.BarChart(document.getElementById('chart_div"+seq+"')); \n");
        }
